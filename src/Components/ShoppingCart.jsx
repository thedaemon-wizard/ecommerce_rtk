...
import { removeItemFromCart, clearCart, increaseItemQuantity, decreaseItemQuantity } from './CartSlice'; // アイテムの数量を増減させるためのアクションクリエーターがあると仮定
import './ShoppingCart.css';
const ShoppingCart = () => {
  ...
  return (
    ...
    <div>{totalAmount ? <div>'合計金額は {totalAmount} です</div> : ''}</div>
